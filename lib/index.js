...
var ReactImageTint = /** @class */ (function (_super) {
    ...
    ReactImageTint.prototype.applyTint = function (src, color) {
        var _this = this;
        if (!utils_1.isColorful(src) && this.imgRef.current) {
            var imgElement = this.imgRef.current;
    ...
    ReactImageTint.prototype.render = function () {
        return (React.createElement("img", { src: this.state.src, alt: this.props.alt, ref: this.imgRef, crossOrigin: "anonymous" }));
    };
